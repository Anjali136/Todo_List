      ...
      <form onSubmit={handleSubmit} className='flex flex-col justify-between h-full w-full'>
        <div>
          ...
          <input
            ...
            className='w-80 h-10 border-b-2 border-blue-900 focus:outline-none text-center font-semibold text-lg bg-inherit text-white'
            required
            value={name}
        ...
        <div>
          ...
          <input
            ...
            name="password"
            placeholder='******'
            className='w-80 h-10 border-b-2 border-blue-900 focus:outline-none text-center bg-inherit text-white'
            required
            value={password}
            onChange={handleInputChange}
          />
        ...
        <button type="submit" className='bg-blue-900 w-[50%] mt-6 self-center p-2 rounded-md text-white font-semibold'>Signup</button>
      </form>
